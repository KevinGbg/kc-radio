...
if Config.Framework == "ESX" then
    ...
    callback = KC.TriggerServerCallback
elseif Config.Framework == "QB" then
    ...
    callback = KC.Functions.TriggerCallback
...
QORE = function()
    ...
    Radio.Open = function(cb)
        callback("radio:getmembers", function(radiomembers)
    ...
    Radio.SetMember = function()
        if Settings.anon then
            callback("radio:setmember", function()
    ...
    Radio.RemoveMember = function()
        if Settings.anon then
            callback("radio:removemember", function()
            end, {id = Radio.id, name = Config.AnonymousName}, Radio.channel)
        else
            callback("radio:removemember", function()
            end, {id = Radio.id, name = Radio.name}, Radio.channel)
